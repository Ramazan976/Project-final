    ...
    <>
      ...
      <div className="flex-col lg:flex-row flex justify-center items-center gap-20 mb-20">
        <div className="relative inline-block w-4xl max-w-[600px]">
          <img
            src="https://preview.colorlib.com/theme/karma/img/login.jpg"
            alt="shoes-black"
        ...
        <div className="flex flex-col gap-7">
          ...
          <input
            ...
            className="border-b border-gray-300 h-10 outline-none w-80 pb-3 placeholder:!text-gray-500"
            value={username}
          ...
          <button
            className="!bg-amber-500 text-white font-medium py-2 w-80 rounded hover:bg-amber-500 transition"
            onClick={handleLogin}
          >
            LOG IN
          </button>
